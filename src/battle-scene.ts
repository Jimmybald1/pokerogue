...
export class BattleScene extends SceneBase {
  ...
  newBattle(
    ...
    if (this.gameMode.isFixedBattle(newWaveIndex) && trainerData === undefined) {
      ...
      if (newBattleType === BattleType.TRAINER) {
        ...
        const variant =
          overrideVariant
          ?? (doubleTrainer ? TrainerVariant.DOUBLE : randSeedInt(2, undefined, "Trainer gender") ? TrainerVariant.FEMALE : TrainerVariant.DEFAULT);
  ...
  public getSpeciesFormIndex(species: PokemonSpecies, gender?: Gender, nature?: Nature, ignoreArena = false): number {
    ...
    switch (species.speciesId) {
      ...
      case SpeciesId.GRENINJA:
        ...
        return randSeedInt(2, undefined, "Species Form Greninja");
  ...
  randomSpecies(
    ...
    return filteredSpecies[randSeedInt(filteredSpecies.length, undefined, "Random Species")];
  }
  ...
  generateRandomBiome(waveIndex: number): BiomeId {
    ...
    // TODO: should this use `randSeedItem`?
    return biomes[randSeedInt(biomes.length, undefined, "Random biome (initial roll failed)")];
  }
