  ...
  applyFixedBattle(waveIndex: number, battleConfig: FixedBattleConfig): boolean {
    ...
    switch (waveIndex) {
      ...
      case ClassicFixedBossWaves.CHAMPION:
        trainerTypes = [
          TrainerType.BLUE,
          Utils.randSeedItem([TrainerType.RED, TrainerType.LANCE_CHAMPION], "Champion (Gen 2)"),
          Utils.randSeedItem([TrainerType.STEVEN, TrainerType.WALLACE], "Champion (Gen 3)"),
          TrainerType.CYNTHIA,
          Utils.randSeedItem([TrainerType.ALDER, TrainerType.IRIS], "Champion (Gen 5)"),
          TrainerType.DIANTHA,
          Utils.randSeedItem([TrainerType.KUKUI, TrainerType.HAU], "Champion (Gen 7)"),
          Utils.randSeedItem([TrainerType.LEON, TrainerType.MUSTARD], "Champion (Gen 8)"),
          Utils.randSeedItem([TrainerType.GEETA, TrainerType.NEMONA], "Champion (Gen 9)"),
        ];
        break;
    }
