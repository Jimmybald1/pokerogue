    ...
    switch (waveIndex) {
      ...
      case ClassicFixedBossWaves.ELITE_FOUR_1:
        trainerTypes = [
          ...
          randSeedItem([TrainerType.MARNIE_ELITE, TrainerType.BEDE_ELITE], "Elite Four (1)"),
          TrainerType.RIKA,
        ];
        break;
      ...
      case ClassicFixedBossWaves.CHAMPION:
        trainerTypes = [
          TrainerType.BLUE,
          randSeedItem([TrainerType.RED, TrainerType.LANCE_CHAMPION], "Champion (Gen 2)"),
          randSeedItem([TrainerType.STEVEN, TrainerType.WALLACE], "Champion (Gen 3)"),
          TrainerType.CYNTHIA,
          randSeedItem([TrainerType.ALDER, TrainerType.IRIS], "Champion (Gen 5)"),
          TrainerType.DIANTHA,
          randSeedItem([TrainerType.KUKUI, TrainerType.HAU], "Champion (Gen 7)"),
          randSeedItem([TrainerType.LEON, TrainerType.MUSTARD], "Champion (Gen 8)"),
          randSeedItem([TrainerType.GEETA, TrainerType.NEMONA], "Champion (Gen 9)"),
        ];
        break;
    }
