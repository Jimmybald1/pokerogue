...
export function getRandomPartyMemberFunc(
  ...
  return (level: number, strength: PartyMemberStrength) => {
    ...
    do {
      species = randSeedItem(species, "Random pokemon from species pool");
    ...
    .setPartyMemberFunc(
      ...
      getRandomPartyMemberFunc([SpeciesId.URSHIFU], TrainerSlot.TRAINER, true, p => {
        ...
        if (p.formIndex === 2) {
          ...
          p.moveset[1] = new PokemonMove(randSeedItem([MoveId.BRICK_BREAK, MoveId.CLOSE_COMBAT], "Random pokemon move"));
          p.moveset[2] = new PokemonMove(randSeedItem([MoveId.FIRE_PUNCH, MoveId.THUNDER_PUNCH, MoveId.ICE_PUNCH], "Random pokemon move"));
          p.moveset[3] = new PokemonMove(randSeedItem([MoveId.IRON_HEAD, MoveId.POISON_JAB, MoveId.STONE_EDGE], "Random pokemon move"));
  ...
  [TrainerType.PENNY_2]: new TrainerConfig(++t)
    ...
    .setPartyMemberFunc(
      ...
      getRandomPartyMemberFunc([SpeciesId.REVAVROOM], TrainerSlot.TRAINER, true, p => {
        ...
        p.gender = Gender.GENDERLESS;
        p.pokeball = PokeballType.ROGUE_BALL;
        p.moveset[0] = new PokemonMove(randSeedItem([MoveId.SPIN_OUT, MoveId.IRON_HEAD], "Random pokemon move")); // Force Moveset to avoid Egg Move bloat from Revavroom / Balancing purposes
        p.moveset[1] = new PokemonMove(MoveId.HIGH_HORSEPOWER);
        switch (p.formIndex) {
          case 1:
            p.moveset[2] = new PokemonMove(MoveId.WICKED_TORQUE);
            p.moveset[3] = new PokemonMove(randSeedItem([MoveId.SNARL, MoveId.SHIFT_GEAR, MoveId.U_TURN], "Random pokemon move"));
            break;
          case 2:
            p.moveset[2] = new PokemonMove(MoveId.BLAZING_TORQUE);
            p.moveset[3] = new PokemonMove(randSeedItem([MoveId.OVERHEAT, MoveId.SCREECH, MoveId.U_TURN], "Random pokemon move")); // Already has Speed Boost
            break;
          case 3:
            p.moveset[2] = new PokemonMove(MoveId.NOXIOUS_TORQUE);
            p.moveset[3] = new PokemonMove(randSeedItem([MoveId.VENOSHOCK, MoveId.SHIFT_GEAR, MoveId.U_TURN], "Random pokemon move"));
            break;
          case 4:
            p.moveset[2] = new PokemonMove(MoveId.MAGICAL_TORQUE);
            p.moveset[3] = new PokemonMove(randSeedItem([MoveId.STEEL_ROLLER, MoveId.SHIFT_GEAR, MoveId.U_TURN], "Random pokemon move"));
            break;
          case 5:
            p.moveset[2] = new PokemonMove(MoveId.COMBAT_TORQUE);
            p.moveset[3] = new PokemonMove(randSeedItem([MoveId.LASH_OUT, MoveId.SHIFT_GEAR, MoveId.U_TURN], "Random pokemon move"));
            break;
        }
      }),
    )
