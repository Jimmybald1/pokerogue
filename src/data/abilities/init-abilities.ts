...
export function initAbilities() {
  (allAbilities as Ability[]).push(
    ...
    new AbBuilder(AbilityId.SHED_SKIN, 3) //
      .conditionalAttr(_pokemon => randSeedInt(10, undefined, "Shed Skin chance") < 3, PostTurnResetStatusAbAttr)
      .build(),
    ...
    new AbBuilder(AbilityId.HEALER, 5) //
      .conditionalAttr(pokemon => pokemon.getAlly() != null && randSeedInt(2, undefined, "Healer chance") === 1, PostTurnResetStatusAbAttr, true)
      .build(),
