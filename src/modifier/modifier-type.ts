...
export class TmModifierType extends PokemonModifierType {
  ...
  get identifier(): string {
    return "TM:" + getEnumKeys(MoveId)[this.moveId];
  }
...
const modifierTypeInitObj = Object.freeze({
  ...
  MINT: () =>
    new ModifierTypeGenerator((_party: Pokemon[], pregenArgs?: any[]) => {
      ...
      return new PokemonNatureChangeModifierType(randSeedItem(getEnumValues(Nature), "Choosing a Mint"));
    }),
  ...
  TERA_SHARD: () =>
    new ModifierTypeGenerator((party: Pokemon[], pregenArgs?: any[]) => {
      ...
      let shardType = randSeedInt(64, undefined, "Choosing whether to give a Stellar Shard") ? (randSeedInt(18, undefined, "Choosing a Tera Shard type to give") as PokemonType) : PokemonType.STELLAR;
      while (shardType === excludedType) {
        shardType = randSeedInt(64, undefined, "Choosing whether to give a Stellar Shard") ? (randSeedInt(18, undefined, "Choosing a Tera Shard type to give") as PokemonType) : PokemonType.STELLAR;
      }
...
export function getEnemyModifierTypesForWave(
  ...
  const ret = new Array(count)
    ...
    .map(
      () =>
        getNewModifierTypeOption(party, poolType, undefined, upgradeChance && !randSeedInt(upgradeChance, undefined, "Chance to upgrade an opponent's item") ? 1 : 0)
