  ...
  globalScene.executeWithSeedOffset(
    () => {
      while (pokerusStarters.length < POKERUS_STARTER_COUNT) {
        const randomSpeciesId = randSeedItem(speciesDataRegistry.getAllStarters(), "Random pokerus starter");
...
export function getRandomRegularPokemonType(): RegularPokemonType {
  return randSeedIntRange(MIN_REGULAR_POKEMON_TYPE, MAX_REGULAR_POKEMON_TYPE, "Random pokemon type") as RegularPokemonType;
}
